...
## Version 7.0 — Complete 17 Native Schemas & Toolkit Architecture Edition (2026-08-13)
...
The `antigravity-schemas` toolkit provides automated schema extraction, validation, and auditing for all original native configuration and runtime artifacts across the Google Antigravity Ecosystem.
...
3. **Contextual Spec Synchronization (`DocSyncInspector`)**: `MarkdownSectionParser` (`src/antigravity_schemas/doc_inspector.py`) parses Markdown files into section blocks, ensuring field documentation coverage is validated strictly within each schema's dedicated section rather than globally.
...
*End of Report — Version 7.0 (Complete 17 Native Schemas & Toolkit Architecture Edition)*